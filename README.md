...
##   in case your experience issues with "This Jenkins instance appears to be offline." 
#    dns:
#      - 1.1.1.1
#      - 8.8.8.8
  ssh-agent:
...
NOTE: read the section [_DNS Configuration_](#dns-configuration) in case you see the message "This Jenkins instance appears to be offline." In that case ad the dns configuration to the yaml:
```yaml
services:
  jenkins:
# ... other config
